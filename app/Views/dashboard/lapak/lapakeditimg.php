                            ...
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header">
                                        <h3 class="text-center font-weight-light my-4">Ganti Gambar Produk</h3>
                                    </div>
                                    <div class="card-body">
                                        ...
                                        <?php endif ?>
                                        <form action="/home/lapak/edit/imageprocess/<?= $data->id_produk ?>" method="post" onchange="loadFile(event)" enctype="multipart/form-data">
                                            <?= csrf_field(); ?>
                                    ...
                                    <div class="card-footer text-center py-3">
                                        <div class="small"><a href="/home/lapak/edit/<?= $data->id_produk; ?>">Cancel</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
