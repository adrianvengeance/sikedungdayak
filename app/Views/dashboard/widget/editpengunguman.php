              ...
              <div class="col-lg-7">
                <div class="card shadow-lg border-0 rounded-lg mt-4">
                  ...
                  <div class="card-body">
                    ...
                    <?php endif ?>
                    <form action="/home/widget/pengunguman/edit/<?= $isi['id'] ?>" method="POST">
                      <?= csrf_field(); ?>
                      <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-label">Isi</label>
                        <input type="text" class="form-control <?= $validation->hasError('isi') ? 'is-invalid' : ''; ?>" name="isi" id="exampleInputEmail1" value="<?= $isi['isi'] ?>">
                        <div class="invalid-feedback"><?= $validation->getError('isi'); ?></div>
                      </div>
                      <div class="mb-3">
                        <label for="exampleInputPassword1" class="form-label">Waktu</label>
                        <input type="datetime-local" class="form-control <?= $validation->hasError('waktu') ? 'is-invalid' : ''; ?>" name="waktu" id="exampleInputPassword1" value="<?= $isi['waktu'] ?>">
                    ...
                    <form action="/home/widget/pengunguman/hapus/<?= $isi['id']; ?>" class="row mt-1" method="post">
                      <?= csrf_field(); ?>
