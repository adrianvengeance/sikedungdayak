                            ...
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-4">
                                    <div class="card-header">
                                        <h3 class="text-center font-weight-light my-4">Link Video YouTube</h3>
                                    </div>
                                    <div class="card-body">
                                        ...
                                        <?php endif ?>
                                        <form action="/home/widget/videoytprocess" method="POST">
                                            <?= csrf_field(); ?>
                                            <label for="inputPassword5" class="form-label">Link</label>
                                            <textarea id="inputPassword5" class="form-control" name="link" aria-describedby="passwordHelpBlock" spellcheck="false" style="height: 120px;" required autofocus></textarea>
