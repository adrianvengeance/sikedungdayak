              ...
              <div class="col-lg-10">
                <div class="card shadow-lg border-0 rounded-lg mt-5">
                  <div class="card-header">
                    <h3 class="text-center font-weight-light my-4">Tambah Berita</h3>
                  </div>
                  <div class="card-body">
                    ...
                    <?php endif ?>
                    <form action="/home/berita/tambahprocess" method="post" enctype="multipart/form-data">
                      <?= csrf_field(); ?>
                      <div class="mb-3">
                      ...
                      <div class="mb-3">
                        <label for="inputbody" class="form-label">Isi Berita</label>
                      ...
                      <div class="row mt-4">
                        <button type="submit" name="submit" class="btn btn-primary text-center mx-auto col-sm-4">Tambah Berita</button>
                      </div>
