                            ...
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header">
                                        <h3 class="text-center font-weight-light my-4">Ganti Gambar Artikel</h3>
                                    </div>
                                    <div class="card-body">
                                        ...
                                        <?php endif ?>
                                        <form action="/home/artikel/edit/imageprocess/<?= $isi['id_news'] ?>" method="post" onchange="loadFile(event)" enctype="multipart/form-data">
                                            <?= csrf_field(); ?>
                                    ...
                                    <div class="card-footer text-center py-3">
                                        <div class="small"><a href="/home/artikel/edit/<?= $isi['id_news']; ?>">Cancel</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
