              ...
              <div class="col-lg-7">
                <div class="card shadow-lg border-0 rounded-lg mt-5">
                  ...
                  <div class="card-body">
                    ...
                    <?php endif ?>
                    <form action="/home/pictures/smallimg/editprocess/<?= $data['id'] ?>" method="post" enctype="multipart/form-data">
                      <?= csrf_field(); ?>
                      <div class="mb-3">
                      ...
                      <div class="mb-3">
                        ...
                        <input type="text" name="jabatan" class="form-control <?= ($validation->hasError('jabatan')) ? 'is-invalid' : ''; ?>" id="exampleInputEmail1" value="<?= (is_null(old('jabatan'))) ? $data['jabatan'] : old('jabatan') ?>">
                        <div class="invalid-feedback"><?= $validation->getError('jabatan'); ?></div>
                      </div>
                      <div class="input-group mb-3">
                        <div class="overlay mx-auto">
                          <img src="/gambar/smallimg/<?= $data['gambar'] ?>" class="gambar img-thumbnail rounded mx-auto d-block" alt="<?= $data['gambar']; ?>" id="pic">
                          <div class="tengah">
                      ...
                      <div class="row mt-1">
                        <a class="btn btn-danger text-center mx-auto col-sm-4" data-bs-toggle="modal" data-bs-target="#smallimgmodal"><i class="fas fa-trash-alt"></i> Hapus </a>
                      </div>
...
<!-- The Modal -->
<div class="modal fade" id="smallimgmodal">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <form action="/home/pictures/smallimg/hapus/<?= $data['id'] ?>" method="post">
          <?= csrf_field(); ?>
