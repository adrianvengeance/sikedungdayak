              ...
              <div class="col-lg-7">
                <div class="card shadow-lg border-0 rounded-lg mt-5">
                  <div class="card-header">
                    <h3 class="text-center font-weight-light my-4">Tambah Gambar Kecil</h3>
                  </div>
                  <div class="card-body">
                    ...
                    <?php endif ?>
                    <form action="/home/pictures/smallimg/addprocess" method="post" enctype="multipart/form-data">
                      <?= csrf_field(); ?>
                      <div class="mb-3">
                      ...
                      <div class="mb-3">
                        <label for="desk" class="form-label">Jabatan</label>
                        <input type="text" class="form-control <?= ($validation->hasError('jabatan')) ? 'is-invalid' : ''; ?>" name="jabatan" id="desk"><?= old('jabatan'); ?>
