              ...
              <div class="text-center">
                <button class="btn mx-auto align-text-bottom" disabled>
                  <h5 class="row">
                    ...
                    <span class="col-10">Program Bantuan Sosial<br>Penerima Bantuan Iuran (PBI)</span>
                  </h5>
                </button>
              </div>
            </div>
              ...
              <div class="text-center">
                <button class="btn col-9 align-text-bottom" disabled>
                  <h5 class="row row-cols">
                    ...
                    <div class="col-8 px-0">Program Bantuan Sosial<br>Penerima Bantuan Iuran (PBI)</div>
                  </h5>
                </button>
              </div>
            </div>
            ...
            <?php if (isset($data)) : ?>
              <?php foreach ($data as $d => $orang) : ?>
                <tr>
                  ...
                  <td><?= $orang['pbi'] . ' ' . $orang['pkh'] . ' ' . $orang['bpnt'] . ' ' . $orang['bst'] . ' ' ?>
                  <td><?= $orang['numkk']; ?></td>
                  <td><?= $orang['nik']; ?></td>
                  <td><?= $orang['goldar']; ?></td>
                  <td><?= $orang['agama']; ?></td>
